    ...
    <div className="page-columns">
      <section className="stack">
        ...
        <div className="tab-row">
          <Link href={`/books/${book.slug}?tab=reviews`} className={activeTab === "reviews" ? "tab-link is-active" : "tab-link"}>
            Reviews
          </Link>
          <Link href={`/books/${book.slug}?tab=details`} className={activeTab === "details" ? "tab-link is-active" : "tab-link"}>
            Details
          </Link>
        </div>
      ...
      <aside className="book-actions-rail">
        <Link href="#write-review" className="action-link sticky-review-button">
          Add review
        </Link>
